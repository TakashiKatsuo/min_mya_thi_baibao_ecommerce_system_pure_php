                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="POST" action="variant_option_edit_form.php" enctype="multipart/form-data" class="form form-horizontal">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <input type="hidden" name="Variant_option_id" value="<?= $id ?>">
                                                    </div>
                                                </div>
