<?php 
    ...
    $sql = "SELECT p.*, subcate.* FROM products p, subcategories subcate WHERE p.Subcategory_id=subcate.Subcategory_id AND Product_id=:product_id";
                ...
                <div class="row match-height">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form method="POST" action="variant_option_add.php" enctype="multipart/form-data" class="form form-horizontal">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" name="Variant_option_id" value="<?= AutoID('variant_options','Variant_option_id','VARI_OPT_',4) ?>" class="form-control" required data-validation-required-message="This Code name field is required" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                <select name="Variant_id" class="select2 form-control" required>
                                                                    ...
                                                                    <option value="<?= $variant['Variant_id'] ?>">Codeno: <?= $variant['Variant_id'] ?> / Name: <?= $variant['Variant_name'] ?></option>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" name="Variant_option_name" class="form-control" placeholder="Type the variant option's name" required data-validation-required-message="This name field is required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea name="Variant_option_description" class="form-control" placeholder="Type the variant option's description"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="number" step="any" name="Variant_option_additional_price" class="form-control" placeholder="Type the variant option's additional price" required data-validation-required-message="This name field is required">
                                                        </div>
                                                    </div>
                                                </div>
