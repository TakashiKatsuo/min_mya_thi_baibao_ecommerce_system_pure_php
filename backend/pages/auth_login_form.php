    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <section class="row flexbox-container" id="authbox">
                                            ...
                                            <div class="card-body pt-1">
                                                <form action="auth_login.php" method="POST">
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left">
                                                        <input type="password" class="form-control" name="userpassword" id="user-password" placeholder="Password" required>
                                                        <div class="form-control-position">
                                                    ...
                                                    <a href="auth_register_form.php" class="btn btn-outline-primary float-left btn-inline">Register</a>
                                                    <button type="submit" name="btnlogin" class="btn btn-primary float-right btn-inline">Login</button>
                                                </form>
                                            </div>
                                        </div>
                                        <div class="login-footer">
                                            ...
                                            <?php 
                                                if(isset($_GET['error'])==true){
                                                    echo '<font color="#FF0000"><p align="center">Sorry, Your Email or Password is Incorrect.</p></font>';
                                                    $invalid=true;
                                            } ?>
                                        </div>
                                    </div>
